...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Testing_LightSaber p_Testing_LightSaber;
        ...
        public static SteamVR_Input_ActionSet_Testing_LightSaber Testing_LightSaber
        {
            get
            {
                return SteamVR_Actions.p_Testing_LightSaber.GetCopy<SteamVR_Input_ActionSet_Testing_LightSaber>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Testing_LightSaber = ((SteamVR_Input_ActionSet_Testing_LightSaber)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Testing_LightSaber>("/actions/Testing_LightSaber")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Testing_LightSaber};
        }
    }
}
